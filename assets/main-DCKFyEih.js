import{l as a}from"./config-BIbxg2R--DzfPGOwd-BhSlepLY-4h9jTUR1-xx9YZiOZ-By2BGC65-BdR0q-ax-DGB18c8q-BnnrN88W-D7vtoPJo-C5n8C-tz.js";function i(){const s=document.getElementById("bookshelf");s&&(s.innerHTML="",a.stories.forEach((e,o)=>{const t=document.createElement("a");t.className=`book-card ${e.id}-card`,t.href=`./story.html?id=${e.id}`,t.dataset.story=e.id,t.innerHTML=`
