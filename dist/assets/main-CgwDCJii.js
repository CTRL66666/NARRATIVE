import{u as a}from"./config-BIbxg2R--DzfPGOwd-BhSlepLY.js";function i(){const s=document.getElementById("bookshelf");s&&(s.innerHTML="",a.stories.forEach((e,o)=>{const t=document.createElement("a");t.className=`book-card ${e.id}-card`,t.href=`./story.html?id=${e.id}`,t.dataset.story=e.id,t.innerHTML=`
