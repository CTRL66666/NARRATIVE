import{l as a}from"./config-BIbxg2R--DzfPGOwd-BhSlepLY-4h9jTUR1-xx9YZiOZ-By2BGC65-BdR0q-ax-DGB18c8q-BnnrN88W-D7vtoPJo.js";function i(){const s=document.getElementById("bookshelf");s&&(s.innerHTML="",a.stories.forEach((t,o)=>{const e=document.createElement("a");e.className=`book-card ${t.id}-card`,e.href=`./story.html?id=${t.id}`,e.dataset.story=t.id,e.innerHTML=`
