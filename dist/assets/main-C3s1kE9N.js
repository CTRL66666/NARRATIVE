import{c as a}from"./config-BIbxg2R-.js";function n(){const t=document.getElementById("bookshelf");t&&(t.innerHTML="",a.stories.forEach((s,i)=>{const e=document.createElement("a");e.className=`book-card ${s.id}-card`,e.href=`./story.html?id=${s.id}`,e.dataset.story=s.id,e.innerHTML=`
